...
from custom_components.jq300 import async_setup_entry
from custom_components.jq300.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch(
        "custom_components.integration_blueprint.JqApiClient.async_set_title"
    ) as title_func:
